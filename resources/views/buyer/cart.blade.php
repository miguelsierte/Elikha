                ...
                <div class="btn-group">
                    ...
                    <script>
                        $('.sort-option').on('click', function() {
                            ...
                            if (sortType === 'all') {
                                $('.card[data-artwork-type]').show(); 
                            } else if (sortType === 'for_sale') {
                                $('.card[data-artwork-type="auctioned"]').hide(); 
                                $('.card[data-artwork-type="for_sale"]').show(); 
                            } else if (sortType === 'auctioned') {
                                $('.card[data-artwork-type="for_sale"]').hide(); 
                                $('.card[data-artwork-type="auctioned"]').show(); 
                            }
                            $('.order-details').show();
                        });
                    </script>
